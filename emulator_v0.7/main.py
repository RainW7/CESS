...
5.  Update the emission line detection module with specutils package to find the emission lines in both simulated intrinsic and noisy spectra.
6.  Add a upper limit for electron spectra with 90000 e-.
...
class emulator(object):
    ...
    def sls_wave_spec(self, highres_wave, highres_flux, redshift, grism):
        ...
        mask = (redshift[:]  > 0.0001) & (redshift[:]  < 10) # there are problems in some source DESI phot catalog, see problem 1 in errors.log
    ...
    def kernels_convolve(self,highres_wave,highres_flux,redshift,grism,REE80):
        ...
        ----------
            ...
            redshift - redshift array for the input catalog, one single array, [10000+,] - [array]
            grism - CSST grism bands, in 'GU', 'GV', and 'GI' - [string]
            REE80 - CSST PSF 80 %\energy concentration radius, average <= 0.3'', max <= 0.4'' - [float]
